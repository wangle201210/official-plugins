// Package settings persists linapro-storage-oss admin settings through host sys_config.
package settings
...
const (
	ConfigKeyAccessKeyID     hostconfigcap.SysConfigKey = "plugin.linapro-storage-oss.access_key_id"
	ConfigKeySecretAccessKey hostconfigcap.SysConfigKey = "plugin.linapro-storage-oss.secret_access_key"
	ConfigKeyRegion          hostconfigcap.SysConfigKey = "plugin.linapro-storage-oss.region"
	ConfigKeyBucket          hostconfigcap.SysConfigKey = "plugin.linapro-storage-oss.bucket"
	ConfigKeyEndpoint        hostconfigcap.SysConfigKey = "plugin.linapro-storage-oss.endpoint"
	ConfigKeyPathPrefix      hostconfigcap.SysConfigKey = "plugin.linapro-storage-oss.path_prefix"
)
