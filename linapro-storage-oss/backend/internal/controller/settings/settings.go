// Package settings implements admin settings HTTP handlers for linapro-storage-oss.
package settings

import (
	objstore "lina-plugin-linapro-storage-oss/backend/internal/service/objstore"
