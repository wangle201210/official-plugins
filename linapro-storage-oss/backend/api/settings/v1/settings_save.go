...
type SaveSettingsReq struct {
	g.Meta          `path:"/settings" method:"put" tags:"Storage / Alibaba Cloud OSS" summary:"Save object storage settings" dc:"Persist cloud object storage settings. Empty or masked secret keeps the previous value." permission:"linapro-storage-oss:settings:update"`
