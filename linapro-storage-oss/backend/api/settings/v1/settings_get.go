...
type GetSettingsReq struct {
	g.Meta `path:"/settings" method:"get" tags:"Storage / Alibaba Cloud OSS" summary:"Query object storage settings" dc:"Return masked cloud object storage settings for the admin page." permission:"linapro-storage-oss:settings:view"`
}
