...
FROM (VALUES
    ('NIU-001','special','college','信工守护牛','信息工程学院',30.70516,103.86276,'active',true),
    ('NIU-002','special','college','水院奔流牛','水利水电学院',30.70534,103.86342,'active',true),
    ('NIU-003','special','spirit','川农魂','农学院',30.70495,103.86192,'active',true),
    ('NIU-004','special','contribution','奉献牛','动物科技学院',30.70561,103.86393,'active',true),
    ('NIU-005','special','alumni','校友纪念牛','经济学院',30.70468,103.86120,'inactive',false),
    ('NIU-006','common','','望江牛','风景园林学院',30.70600,103.86498,'active',true),
    ('NIU-007','common','','耕读牛','食品学院',30.70434,103.86042,'inactive',false),
    ('NIU-008','common','','勤学牛','林学院',30.70636,103.86582,'active',true),
    ('NIU-009','common','','笃行牛','农学院',30.70404,103.85975,'inactive',false),
    ('NIU-010','common','','至善牛','信息工程学院',30.70676,103.86665,'active',true)
