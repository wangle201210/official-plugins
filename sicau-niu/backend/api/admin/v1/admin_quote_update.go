...
type UpdateQuoteReq struct {
	g.Meta  `path:"/plugins/sicau-niu/admin/quotes/{id}" method:"put" tags:"Sicau Niu Admin" summary:"Update quote" dc:"Update a quote's content and enabled flag. The content must stay non-empty. Protected by host unified permission check." permission:"sicau-niu:quote:update"`
