...
type UpdateIronReq struct {
	g.Meta `path:"/plugins/sicau-niu/admin/iron/{id}" method:"put" tags:"Sicau Niu Admin" summary:"Update iron-cow" dc:"Update an iron-cow's code, name and remark. The code must stay unique among active iron-cows. Real-time location fields are not changed here. Protected by host unified permission check." permission:"sicau-niu:iron:update"`
