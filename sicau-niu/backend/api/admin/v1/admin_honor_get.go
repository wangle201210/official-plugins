...
type GetHonorReq struct {
	g.Meta `path:"/plugins/sicau-niu/admin/honors/{id}" method:"get" tags:"Sicau Niu Admin" summary:"Get honor definition" dc:"Fetch one honor definition detail by ID. Protected by host unified permission check." permission:"sicau-niu:honor:list"`
