...
type CreateQuoteReq struct {
	g.Meta  `path:"/plugins/sicau-niu/admin/quotes" method:"post" tags:"Sicau Niu Admin" summary:"Create quote" dc:"Create a non-empty school-history quote for the random-playback pool. Enabled defaults to 1 when omitted. Protected by host unified permission check." permission:"sicau-niu:quote:create"`
