...
type CreateCollegeReq struct {
	g.Meta `path:"/plugins/sicau-niu/admin/colleges" method:"post" tags:"Sicau Niu Admin" summary:"Create college" dc:"Create a college dictionary entry with a unique name. Protected by host unified permission check." permission:"sicau-niu:college:create"`
