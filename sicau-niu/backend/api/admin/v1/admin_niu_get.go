...
type GetNiuReq struct {
	g.Meta `path:"/plugins/sicau-niu/admin/niu/{id}" method:"get" tags:"Sicau Niu Admin" summary:"Get cattle" dc:"Fetch one cattle detail by ID, including the batch-assembled college name and main-card binding flag. Protected by host unified permission check." permission:"sicau-niu:niu:list"`
