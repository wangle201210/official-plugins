...
type UpdateCollegeReq struct {
	g.Meta `path:"/plugins/sicau-niu/admin/colleges/{id}" method:"put" tags:"Sicau Niu Admin" summary:"Update college" dc:"Update a college's name and sort order. The name must stay unique among active colleges. Protected by host unified permission check." permission:"sicau-niu:college:update"`
