...
type CollegeOptionsReq struct {
	g.Meta `path:"/plugins/sicau-niu/colleges" method:"get" tags:"寻牛小程序" summary:"查询院系选项" dc:"Return the bounded, sort-ordered college dropdown for player identity selection. The full active set is returned in one response. Requires a valid player token."`
}
