...
type IPlayerV1 interface {
	...
	ReportTransportContribution(ctx context.Context, req *v1.ReportTransportContributionReq) (res *v1.ReportTransportContributionRes, err error)
	ListMyTransportReports(ctx context.Context, req *v1.ListMyTransportReportsReq) (res *v1.ListMyTransportReportsRes, err error)
	...
	GetTransportTeam(ctx context.Context, req *v1.GetTransportTeamReq) (res *v1.GetTransportTeamRes, err error)
	ListTransportMembers(ctx context.Context, req *v1.ListTransportMembersReq) (res *v1.ListTransportMembersRes, err error)
}
