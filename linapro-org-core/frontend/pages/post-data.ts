  ...
  return [
    {
      component: 'Input',
      fieldName: 'code',
      label: $t('plugin.linapro-org-core.post.fields.code'),
    },
    {
      component: 'Input',
      fieldName: 'name',
      label: $t('plugin.linapro-org-core.post.fields.name'),
    },
    {
      component: 'Select',
      fieldName: 'status',
...
export function buildColumns(): VxeGridProps['columns'] {
  return [
    ...
    {
      field: 'code',
      title: $t('plugin.linapro-org-core.post.fields.code'),
      minWidth: 120,
    },
    {
      field: 'name',
      title: $t('plugin.linapro-org-core.post.fields.name'),
      minWidth: 120,
    },
    {
      field: 'sort',
  ...
  return [
    {
      ...
      fieldName: 'deptId',
      label: $t('plugin.linapro-org-core.post.fields.dept'),
    ...
    },
    {
      ...
      fieldName: 'sort',
      label: $t('plugin.linapro-org-core.post.fields.sortOrder'),
      defaultValue: 0,
    },
    {
