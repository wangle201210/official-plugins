  ...
  return [
    {
      component: 'Input',
      fieldName: 'name',
      label: $t('plugin.linapro-org-core.dept.fields.name'),
    },
    {
      component: 'Select',
      fieldName: 'status',
      label: $t('plugin.linapro-org-core.dept.fields.status'),
    },
  ];
}
...
export function buildColumns(): VxeGridProps['columns'] {
  return [
    {
      field: 'name',
      title: $t('plugin.linapro-org-core.dept.fields.name'),
      treeNode: true,
      minWidth: 200,
    },
    {
      field: 'code',
      title: $t('plugin.linapro-org-core.dept.fields.code'),
      minWidth: 120,
    },
    {
      field: 'orderNum',
  ...
  return [
    {
      ...
      fieldName: 'parentId',
      label: $t('plugin.linapro-org-core.dept.fields.parentDept'),
    ...
    },
    {
      component: 'Input',
      fieldName: 'code',
      label: $t('plugin.linapro-org-core.dept.fields.code'),
    },
    {
      component: 'InputNumber',
      fieldName: 'orderNum',
      label: $t('plugin.linapro-org-core.dept.fields.sortOrder'),
      rules: 'required',
      defaultValue: 0,
    },
    {
      ...
      fieldName: 'leader',
      label: $t('plugin.linapro-org-core.dept.fields.leader'),
    },
    {
      component: 'Input',
      fieldName: 'phone',
      label: $t('plugin.linapro-org-core.dept.fields.phone'),
    },
    {
      component: 'Input',
      fieldName: 'email',
