// This file keeps linapro-demo-source API DTO boundary checks inside the plugin module.
...
// TestDemoSourceAPIsDoNotDependOnGeneratedEntities ensures public API contracts do not import database entities.
func TestDemoSourceAPIsDoNotDependOnGeneratedEntities(t *testing.T) {
	assertNoGeneratedEntityImports(t, demoSourcePluginRoot(t))
}

// TestDemoSourceAPIDTOsDoNotUseEntityNaming ensures response DTOs use API-oriented names.
func TestDemoSourceAPIDTOsDoNotUseEntityNaming(t *testing.T) {
	assertNoEntityTypeNames(t, demoSourcePluginRoot(t))
}

// TestDemoSourceAPIDTOFilesAvoidLegacyNames rejects legacy DTO-only file naming.
func TestDemoSourceAPIDTOFilesAvoidLegacyNames(t *testing.T) {
	assertNoLegacyDTOFiles(t, demoSourcePluginRoot(t))
}

// TestDemoSourceAPIDocI18NDoesNotReferenceRemovedDTOFields keeps apidoc translations aligned with DTOs.
func TestDemoSourceAPIDocI18NDoesNotReferenceRemovedDTOFields(t *testing.T) {
