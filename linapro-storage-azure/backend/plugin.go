// Package backend wires linapro-storage-azure into the host plugin registry and storagecap provider registry.
package backend
...
import (
	...
	pluginroot "lina-plugin-linapro-storage-azure"
	settingsctrl "lina-plugin-linapro-storage-azure/backend/internal/controller/settings"
	"lina-plugin-linapro-storage-azure/backend/internal/service/objstore"
...
func registerRoutes(ctx context.Context, registrar pluginhost.HTTPRegistrar) error {
	...
	if services == nil || services.HostConfig() == nil || services.HostConfig().SysConfig() == nil {
		return gerror.New("linapro-storage-azure routes require host sys_config capability")
	}
	logger.Infof(ctx, "linapro-storage-azure registering settings routes")
