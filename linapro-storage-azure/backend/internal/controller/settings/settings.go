// Package settings implements admin settings HTTP handlers for linapro-storage-azure.
package settings

import (
	objstore "lina-plugin-linapro-storage-azure/backend/internal/service/objstore"
