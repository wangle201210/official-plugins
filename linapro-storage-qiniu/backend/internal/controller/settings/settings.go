// Package settings implements admin settings HTTP handlers for linapro-storage-qiniu.
package settings

import (
	objstore "lina-plugin-linapro-storage-qiniu/backend/internal/service/objstore"
