...
type UpdateTenantStreamConfigReq struct {
	g.Meta        `path:"/media/tenant-stream-configs/{oldTenantId}/nodes/{oldNodeNum}" method:"put" tags:"租户流配置" summary:"修改租户流配置" dc:"按原租户ID和原节点编号修改租户流配置。" permission:"media:management:edit"`
