...
type DeleteDeviceNodeReq struct {
	g.Meta    `path:"/media/device-nodes/{deviceId}/channels/{channelId}" method:"delete" tags:"媒体管理" summary:"删除设备节点" dc:"按设备国标ID和设备通道ID删除设备节点关系。" permission:"media:management:remove"`
