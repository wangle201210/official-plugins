...
type ListDeviceNodesReq struct {
	g.Meta   `path:"/media/device-nodes" method:"get" tags:"媒体管理" summary:"查询设备节点列表" dc:"分页查询设备节点关系，支持按设备国标ID、设备通道ID或节点编号模糊筛选。" permission:"media:management:query"`
	PageNum  int    `json:"pageNum" d:"1" v:"min:1" dc:"页码" eg:"1"`
	PageSize int    `json:"pageSize" d:"10" v:"min:1|max:100" dc:"每页条数" eg:"10"`
	Keyword  string `json:"keyword" dc:"按设备国标ID、设备通道ID或节点编号模糊筛选" eg:"34020000001320000001"`
}
