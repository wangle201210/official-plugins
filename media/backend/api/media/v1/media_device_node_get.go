...
type GetDeviceNodeReq struct {
	g.Meta    `path:"/media/device-nodes/{deviceId}/channels/{channelId}" method:"get" tags:"设备节点" summary:"查询设备节点详情" dc:"按设备国标ID和设备通道ID查询设备节点关系。" permission:"media:management:query"`
