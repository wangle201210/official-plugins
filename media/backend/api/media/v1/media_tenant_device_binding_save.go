...
type SaveTenantDeviceBindingReq struct {
	g.Meta     `path:"/media/tenant-device-bindings/{tenantId}/{deviceId}" method:"put" tags:"策略绑定" summary:"保存租户设备策略绑定" dc:"按租户ID和设备国标ID创建或替换租户设备策略绑定。" permission:"media:management:edit"`
