...
type ListTenantStreamConfigsReq struct {
	g.Meta   `path:"/media/tenant-stream-configs" method:"get" tags:"租户流配置" summary:"查询租户流配置列表" dc:"分页查询租户和节点组合唯一的租户流配置，支持按租户ID或节点编号模糊筛选。" permission:"media:management:query"`
