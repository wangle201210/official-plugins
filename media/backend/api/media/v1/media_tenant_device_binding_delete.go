...
type DeleteTenantDeviceBindingReq struct {
	g.Meta   `path:"/media/tenant-device-bindings/{tenantId}/{deviceId}" method:"delete" tags:"策略绑定" summary:"删除租户设备策略绑定" dc:"按租户ID和设备国标ID删除租户设备策略绑定。" permission:"media:management:remove"`
