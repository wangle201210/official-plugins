...
type UpdateDeviceNodeReq struct {
	...
	ChannelId    string `json:"channelId" v:"required|length:1,64#设备通道ID不能为空|设备通道ID长度不能超过64个字符" dc:"设备通道ID" eg:"34020000001320000002"`
...
type UpdateDeviceNodeRes struct {
	...
	ChannelId string `json:"channelId" dc:"设备通道ID" eg:"34020000001320000002"`
}
