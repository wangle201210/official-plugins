...
type IMediaV1 interface {
	...
	ListDashboardInstances(ctx context.Context, req *v1.ListDashboardInstancesReq) (res *v1.ListDashboardInstancesRes, err error)
	...
	ListStrategyDeviceBindings(ctx context.Context, req *v1.ListStrategyDeviceBindingsReq) (res *v1.ListStrategyDeviceBindingsRes, err error)
	...
	ListStrategyTenantBindings(ctx context.Context, req *v1.ListStrategyTenantBindingsReq) (res *v1.ListStrategyTenantBindingsRes, err error)
