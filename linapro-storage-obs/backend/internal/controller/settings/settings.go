// Package settings implements admin settings HTTP handlers for linapro-storage-obs.
package settings

import (
	objstore "lina-plugin-linapro-storage-obs/backend/internal/service/objstore"
