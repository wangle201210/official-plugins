// Package settings persists linapro-storage-obs admin settings through host sys_config.
package settings
...
const (
	ConfigKeyAccessKeyID     hostconfigcap.SysConfigKey = "plugin.linapro-storage-obs.access_key_id"
	ConfigKeySecretAccessKey hostconfigcap.SysConfigKey = "plugin.linapro-storage-obs.secret_access_key"
	ConfigKeyRegion          hostconfigcap.SysConfigKey = "plugin.linapro-storage-obs.region"
	ConfigKeyBucket          hostconfigcap.SysConfigKey = "plugin.linapro-storage-obs.bucket"
	ConfigKeyEndpoint        hostconfigcap.SysConfigKey = "plugin.linapro-storage-obs.endpoint"
	ConfigKeyPathPrefix      hostconfigcap.SysConfigKey = "plugin.linapro-storage-obs.path_prefix"
)
