...
type GetSettingsReq struct {
	g.Meta `path:"/settings" method:"get" tags:"Storage / Huawei Cloud OBS" summary:"Query object storage settings" dc:"Return masked cloud object storage settings for the admin page." permission:"linapro-storage-obs:settings:view"`
}
