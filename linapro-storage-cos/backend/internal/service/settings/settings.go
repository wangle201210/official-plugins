// Package settings persists linapro-storage-cos admin settings through host sys_config.
package settings
...
const (
	ConfigKeyAccessKeyID     hostconfigcap.SysConfigKey = "plugin.linapro-storage-cos.access_key_id"
	ConfigKeySecretAccessKey hostconfigcap.SysConfigKey = "plugin.linapro-storage-cos.secret_access_key"
	ConfigKeyRegion          hostconfigcap.SysConfigKey = "plugin.linapro-storage-cos.region"
	ConfigKeyBucket          hostconfigcap.SysConfigKey = "plugin.linapro-storage-cos.bucket"
	ConfigKeyEndpoint        hostconfigcap.SysConfigKey = "plugin.linapro-storage-cos.endpoint"
	ConfigKeyPathPrefix      hostconfigcap.SysConfigKey = "plugin.linapro-storage-cos.path_prefix"
)
