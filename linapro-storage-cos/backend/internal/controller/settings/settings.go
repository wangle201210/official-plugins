// Package settings implements admin settings HTTP handlers for linapro-storage-cos.
package settings

import (
	objstore "lina-plugin-linapro-storage-cos/backend/internal/service/objstore"
