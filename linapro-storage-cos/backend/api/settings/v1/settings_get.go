...
type GetSettingsReq struct {
	g.Meta `path:"/settings" method:"get" tags:"Storage / Tencent COS" summary:"Query object storage settings" dc:"Return masked cloud object storage settings for the admin page." permission:"linapro-storage-cos:settings:view"`
}
