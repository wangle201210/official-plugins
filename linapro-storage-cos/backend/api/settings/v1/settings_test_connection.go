...
type TestConnectionReq struct {
	g.Meta          `path:"/settings/test-connection" method:"post" tags:"Storage / Tencent COS" summary:"Test object storage connectivity" dc:"Probe the target bucket with the submitted or previously saved credentials without persisting changes." permission:"linapro-storage-cos:settings:view"`
