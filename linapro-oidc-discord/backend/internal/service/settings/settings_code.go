// settings_code.go declares linapro-oidc-discord settings business error codes.
...
var (
	...
	CodeStorageUnavailable = bizerr.MustDefine(
		"PLUGIN_OIDC_DISCORD_SETTINGS_STORAGE_UNAVAILABLE",
	...
	CodeReadFailed = bizerr.MustDefine(
		"PLUGIN_OIDC_DISCORD_SETTINGS_READ_FAILED",
		"Failed to read Discord OIDC settings",
		gcode.CodeInternalError,
	)
	// CodeSaveFailed reports that persisting settings values failed.
	CodeSaveFailed = bizerr.MustDefine(
		"PLUGIN_OIDC_DISCORD_SETTINGS_SAVE_FAILED",
		"Failed to save Discord OIDC settings",
		gcode.CodeInternalError,
	)
	...
	CodeRulesInvalid = bizerr.MustDefine(
		"PLUGIN_OIDC_DISCORD_SETTINGS_RULES_INVALID",
