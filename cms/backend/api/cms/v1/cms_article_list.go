...
type ArticleListReq struct {
	...
	CategoryType    int    `json:"categoryType" v:"in:0,1,2,3,4,5#gf.gvalid.rule.in" dc:"Filter by category type: 1=list, 2=single page, 3=external link, 4=product, 5=album" eg:"1"`
