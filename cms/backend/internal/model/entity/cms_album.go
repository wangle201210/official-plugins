...
// CmsAlbum is the golang structure for table cms_album.
type CmsAlbum struct {
	Id          int64       `json:"id"          orm:"id"          description:"Album ID"`
	CategoryId  int64       `json:"categoryId"  orm:"category_id" description:"Category ID"`
	Name        string      `json:"name"        orm:"name"        description:"Album name"`
	Cover       string      `json:"cover"       orm:"cover"       description:"Cover image URL"`
	Description string      `json:"description" orm:"description" description:"Album description"`
