// Package settings implements admin settings HTTP handlers for linapro-storage-s3.
package settings

import (
	objstore "lina-plugin-linapro-storage-s3/backend/internal/service/objstore"
