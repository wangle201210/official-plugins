...
type TestConnectionReq struct {
	g.Meta          `path:"/settings/test-connection" method:"post" tags:"Storage / S3" summary:"Test object storage connectivity" dc:"Probe the target S3 bucket with the submitted or previously saved credentials without persisting changes." permission:"linapro-storage-s3:settings:view"`
