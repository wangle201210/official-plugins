...
type TestConnectionReq struct {
	g.Meta          `path:"/settings/test-connection" method:"post" tags:"Storage / AWS" summary:"Test object storage connectivity" dc:"Probe the target AWS S3 bucket with the submitted or previously saved credentials without persisting changes." permission:"linapro-storage-aws:settings:view"`
