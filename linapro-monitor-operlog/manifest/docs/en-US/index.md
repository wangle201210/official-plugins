...
Official source plugin for operation-log persistence and governance.
...
- Official source plugin for operation-log persistence and governance.
- Provides workbench entry points for Audit Logs.
- Supports tenant-aware usage scenarios.

## Where It Fits

Use it to observe and govern platform operations, audit records, online sessions, or server metrics.

## Entry Points

| Name | Path |
| --- | --- |
| Audit Logs | `/monitor/operlog` |
