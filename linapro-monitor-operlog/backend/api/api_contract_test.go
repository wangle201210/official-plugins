// This file keeps linapro-monitor-operlog API DTO boundary checks inside the plugin module.
...
import (
	...
	operlogv1 "lina-plugin-linapro-monitor-operlog/backend/api/operlog/v1"
)

// TestOperLogAPIsDoNotDependOnGeneratedEntities ensures public API contracts do not import database entities.
func TestOperLogAPIsDoNotDependOnGeneratedEntities(t *testing.T) {
	assertNoGeneratedEntityImports(t, operLogPluginRoot(t))
}

// TestOperLogAPIDTOsDoNotUseEntityNaming ensures response DTOs use API-oriented names.
func TestOperLogAPIDTOsDoNotUseEntityNaming(t *testing.T) {
	assertNoEntityTypeNames(t, operLogPluginRoot(t))
}

// TestOperLogAPIDTOFilePlacement keeps shared DTOs in the API package main source file.
func TestOperLogAPIDTOFilePlacement(t *testing.T) {
	assertTypeDeclaredInFile(t, operLogPluginRoot(t), map[string]string{
		"operlog/v1/OperLogListItem":   "operlog.go",
		"operlog/v1/OperLogDetailItem": "operlog.go",
	})
}

// TestOperLogAPIDTOFilesAvoidLegacyNames rejects legacy DTO-only file naming.
func TestOperLogAPIDTOFilesAvoidLegacyNames(t *testing.T) {
	assertNoLegacyDTOFiles(t, operLogPluginRoot(t))
}

// TestOperLogResponseDTOsHideInternalFields verifies implementation fields stay out of responses.
func TestOperLogResponseDTOsHideInternalFields(t *testing.T) {
	assertJSONFieldsAbsent(t, "operlog.OperLogListItem", reflect.TypeOf(operlogv1.OperLogListItem{}), internalResponseFields())
	assertJSONFieldsAbsent(t, "operlog.OperLogDetailItem", reflect.TypeOf(operlogv1.OperLogDetailItem{}), internalResponseFields())
}

// TestOperLogListDTOExcludesPayloads keeps large audited payloads out of list responses.
func TestOperLogListDTOExcludesPayloads(t *testing.T) {
...
// TestOperLogAPIDocI18NDoesNotReferenceRemovedDTOFields keeps apidoc translations aligned with DTOs.
func TestOperLogAPIDocI18NDoesNotReferenceRemovedDTOFields(t *testing.T) {
	assertAPIDocI18NExcludesTokens(t, operLogPluginRoot(t), []string{
		"OperLogEntity",
		"deletedAt",
	})
}

// operLogPluginRoot returns the plugin root directory for path-based contract checks.
func operLogPluginRoot(t *testing.T) string {
	t.Helper()
