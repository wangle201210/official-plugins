...
type CasLoginReq struct {
	g.Meta `path:"/api/v1/cas-login/index" method:"get" tags:"UIdentity CAS" summary:"Validate CAS ticket" dc:"Validate a CAS ticket through the plugin-configured CAS service validation URL, resolve the returned work code to a plugin account, enforce application access rules and blacklists, and record a CAS login log."`
