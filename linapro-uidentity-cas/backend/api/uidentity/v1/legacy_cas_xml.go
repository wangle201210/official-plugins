...
type LegacyCASServiceValidateXMLReq struct {
	g.Meta `path:"/sso/serviceValidate" method:"all" tags:"UIdentity Legacy CAS Runtime" summary:"Validate CAS service ticket as XML" dc:"Consume and validate a CAS service ticket, then write a CAS serviceResponse XML document compatible with the old admin serviceValidate endpoint."`
