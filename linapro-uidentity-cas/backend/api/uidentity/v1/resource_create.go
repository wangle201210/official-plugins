...
type ResourceCreateReq struct {
	g.Meta   `path:"/api/v1/account" method:"post" tags:"UIdentity CAS" summary:"Create UIdentity resource record" dc:"Create one plugin-owned UIdentity resource record. The body is a resource-specific field object using API field names; unknown fields are ignored." permission:"uidentity:cas:write"`
