...
type ResourceListReq struct {
	g.Meta      `path:"/api/v1/account" method:"get" tags:"UIdentity CAS" summary:"List UIdentity resource records" dc:"Query one plugin-owned UIdentity resource by page. Supported resources are accounts, account-details, groups, units, containers, applications, account-groups, account-units, account-app-roles, account-app-blacklists, group-app-blacklists, pass-rules, sms-records, cas-login-logs, oauth-logs, oauth-tokens, account-change-logs, and account-active-logs." permission:"uidentity:cas:read"`
