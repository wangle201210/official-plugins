...
type ResourceUpdateReq struct {
	g.Meta   `path:"/api/v1/account/{id}" method:"put" tags:"UIdentity CAS" summary:"Update UIdentity resource record" dc:"Update one plugin-owned UIdentity resource record by ID. The body is a partial resource-specific field object using API field names; omitted fields remain unchanged." permission:"uidentity:cas:write"`
