...
type ResourceGetReq struct {
	g.Meta   `path:"/api/v1/account/{id}" method:"get" tags:"UIdentity CAS" summary:"Get UIdentity resource record" dc:"Read one plugin-owned UIdentity resource record by ID, including stable related-name projections where available." permission:"uidentity:cas:read"`
