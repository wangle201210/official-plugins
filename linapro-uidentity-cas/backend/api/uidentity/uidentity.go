...
type IUidentityV1 interface {
	...
	UserWechatRebindStateCreate(ctx context.Context, req *v1.UserWechatRebindStateCreateReq) (res *v1.UserWechatRebindStateCreateRes, err error)
	UserWechatRebindCallback(ctx context.Context, req *v1.UserWechatRebindCallbackReq) (res *v1.UserWechatRebindCallbackRes, err error)
	UserWechatRebindState(ctx context.Context, req *v1.UserWechatRebindStateReq) (res *v1.UserWechatRebindStateRes, err error)
