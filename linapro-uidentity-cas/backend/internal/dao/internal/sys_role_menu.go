...
// SysRoleMenuColumns defines and stores column names for the table plugin_linapro_uidentity_cas_sys_role_menu.
type SysRoleMenuColumns struct {
	RoleId string //
	MenuId string //
}

// sysRoleMenuColumns holds the columns for the table plugin_linapro_uidentity_cas_sys_role_menu.
...
func NewSysRoleMenuDao(handlers ...gdb.ModelHandler) *SysRoleMenuDao {
	return &SysRoleMenuDao{
		group:    "default",
		table:    "plugin_linapro_uidentity_cas_sys_role_menu",
