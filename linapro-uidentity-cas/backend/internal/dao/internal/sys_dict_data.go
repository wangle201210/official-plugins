...
// SysDictDataColumns defines and stores column names for the table plugin_linapro_uidentity_cas_sys_dict_data.
...
// sysDictDataColumns holds the columns for the table plugin_linapro_uidentity_cas_sys_dict_data.
...
func NewSysDictDataDao(handlers ...gdb.ModelHandler) *SysDictDataDao {
	return &SysDictDataDao{
		group:    "default",
		table:    "plugin_linapro_uidentity_cas_sys_dict_data",
