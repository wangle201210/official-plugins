...
// SysDictTypeColumns defines and stores column names for the table plugin_linapro_uidentity_cas_sys_dict_type.
...
// sysDictTypeColumns holds the columns for the table plugin_linapro_uidentity_cas_sys_dict_type.
...
func NewSysDictTypeDao(handlers ...gdb.ModelHandler) *SysDictTypeDao {
	return &SysDictTypeDao{
		group:    "default",
		table:    "plugin_linapro_uidentity_cas_sys_dict_type",
