...
<template>
  <BasicModal
    ...
    class="w-[550px]"
    :title="$t('plugin.linapro-monitor-loginlog.detail.title')"
  >
    <Descriptions v-if="loginInfo" size="small" :column="1" bordered>
      ...
      <DescriptionsItem :label="$t('plugin.linapro-monitor-loginlog.fields.status')">
        <DictTag :dicts="loginStatusDicts as any" :value="loginInfo.status" />
      </DescriptionsItem>
      <DescriptionsItem :label="$t('plugin.linapro-monitor-loginlog.fields.ipAddress')">
        {{ loginInfo.ip }}
      </DescriptionsItem>
      <DescriptionsItem :label="$t('plugin.linapro-monitor-loginlog.fields.browser')">
        {{ loginInfo.browser }}
      </DescriptionsItem>
      <DescriptionsItem :label="$t('plugin.linapro-monitor-loginlog.fields.os')">
        {{ loginInfo.os }}
      </DescriptionsItem>
      <DescriptionsItem :label="$t('plugin.linapro-monitor-loginlog.fields.message')">
        <span
          class="font-semibold"
      ...
      <DescriptionsItem :label="$t('plugin.linapro-monitor-loginlog.fields.loginTime')">
