// This file keeps linapro-monitor-loginlog API DTO boundary checks inside the plugin module.
...
import (
	...
	loginlogv1 "lina-plugin-linapro-monitor-loginlog/backend/api/loginlog/v1"
)

// TestLoginLogAPIsDoNotDependOnGeneratedEntities ensures public API contracts do not import database entities.
func TestLoginLogAPIsDoNotDependOnGeneratedEntities(t *testing.T) {
	assertNoGeneratedEntityImports(t, loginLogPluginRoot(t))
}

// TestLoginLogAPIDTOsDoNotUseEntityNaming ensures response DTOs use API-oriented names.
func TestLoginLogAPIDTOsDoNotUseEntityNaming(t *testing.T) {
	assertNoEntityTypeNames(t, loginLogPluginRoot(t))
}

// TestLoginLogAPIDTOFilePlacement keeps shared DTOs in the API package main source file.
func TestLoginLogAPIDTOFilePlacement(t *testing.T) {
	assertTypeDeclaredInFile(t, loginLogPluginRoot(t), map[string]string{
		"loginlog/v1/LoginLogItem": "loginlog.go",
	})
}

// TestLoginLogAPIDTOFilesAvoidLegacyNames rejects legacy DTO-only file naming.
func TestLoginLogAPIDTOFilesAvoidLegacyNames(t *testing.T) {
	assertNoLegacyDTOFiles(t, loginLogPluginRoot(t))
}

// TestLoginLogResponseDTOsHideInternalFields verifies implementation fields stay out of responses.
func TestLoginLogResponseDTOsHideInternalFields(t *testing.T) {
	assertJSONFieldsAbsent(t, "loginlog.LoginLogItem", reflect.TypeOf(loginlogv1.LoginLogItem{}), internalResponseFields())
}

// TestLoginLogAPIDocI18NDoesNotReferenceRemovedDTOFields keeps apidoc translations aligned with DTOs.
func TestLoginLogAPIDocI18NDoesNotReferenceRemovedDTOFields(t *testing.T) {
	assertAPIDocI18NExcludesTokens(t, loginLogPluginRoot(t), []string{
		"LoginLogEntity",
		"deletedAt",
	})
}

// loginLogPluginRoot returns the plugin root directory for path-based contract checks.
func loginLogPluginRoot(t *testing.T) string {
	t.Helper()
